package ru.java.mvc.javaconfig;
...
import ru.java.mvc.mvc.quartz.CronQuartzTask;
import ru.java.mvc.mvc.quartz.QuartzTask;

import java.util.Properties;

@Configuration
@PropertySource(value = "classpath:util.properties") //<context:property-placeholder location=".." />
@ComponentScan(basePackages = "ru.java.mvc.mvc.scheduling")
...
public class ApplicationConfig {
    ...
    public LocalContainerEntityManagerFactoryBean getLocalContainerEntityManagerFactoryBean() {
        ...
        em.setPackagesToScan(new String[] {"ru.java.mvc.mvc.bean","ru.java.mvc.mvc.rest.model"});
   ...
   /* Quartz scheduling configuration */
    ...
    /**
     *  <bean id="simpleQuartzTask" class="ru.java.mvc.mvc.quartz.QuartzTask" />
     */
    ...
    /**
     *   <bean id="cronQuartzTask" class="ru.java.mvc.mvc.quartz.CronQuartzTask" />
     */
